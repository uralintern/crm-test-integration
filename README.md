...
2. Для локального запуска ничего заполнять не нужно: `.env.example` уже содержит безопасные dev-значения. При необходимости можно изменить пароли или токены в `.env`.
